...
from .utils import ALGOS, create_test_env, get_latest_run_id, get_saved_hyperparams, StoreDict
...
if __name__ == '__main__':
    ...
    print('env_kwargs: {}'.format(args.env_kwargs))
    ...
    if env_id == 'ReacherBulletEnv-v0':
        print('hi')
        # print(env.venv.venv.get_attr('_cam_dist'))
        # env.venv._cam_dist = 1
